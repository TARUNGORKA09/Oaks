            ...
            if(!_.isEmpty(data[0])){
                for (let i = 0; i < data[0].length; i++) {
                    ...
                    await commonFunction.insertIntoTable({}, "tb_order_details", "inserting product table", {
                        ...
                        username,
                        order_time,
                        product_id : refData[0].product_id,
                        product_type : refData[0].product_type,
                        product_price :refData[0].product_price,
                        product_name : refData[0].product_name,
                        product_description : refData[0].product_description,
                        product_quantity : refData[0].product_quantity,
                        product_mrp : refData[0].product_mrp,
                        product_discount : refData[0].product_discount
                  })
                  let data = await 
